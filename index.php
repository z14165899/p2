...
<body>
    ...
    <form method='POST' action='index.php'>
        <fieldset class='text'>
            ...
            <?php if (!$firstTerm) : ?>
            <div class='alert alert-warning'>Please enter a nonzero numeric first term.</div>
            <?php endif; ?>
        </fieldset>
        <br>
        <fieldset class='text'>
            ...
            <?php if (!$factor) : ?>
            <div class='alert alert-warning'>Please enter a nonzero numeric factor term.</div>
            <?php endif; ?>
        </fieldset>
        <br>
        <fieldset class='text'>
            ...
            <?php if (!$terms) : ?>
            <div class='alert alert-warning'>Please enter a nonzero numeric number of terms.</div>
            <?php endif; ?>
        </fieldset>
        <br>
